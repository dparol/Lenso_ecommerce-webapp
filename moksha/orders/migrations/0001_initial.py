    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('Accepted', 'Accepted'), ('Ready to ship', 'Ready to ship'), ('On shipping', 'On shipping'), ('Delivered', 'Delivered'), ('Cancelled', 'Cancelled'), ('return', 'return'), ('Refunded', 'Refunded')], default='Accepted', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
